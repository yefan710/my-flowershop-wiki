...
const coreRoutes = [
  {
    ...
    inside: "Follow planting, growth, harvesting, and offline progress before you commit cash or time.",
    result: "Understand where flowers fit in the shop loop.",
    image: "/hero-bg.jpg",
  ...
  },
  {
    ...
    inside: "How harvested flowers connect to arrangements and customer sales.",
    result: "Know what crafting changes before using your stock.",
  ...
  },
  {
    ...
    inside: "A task-first map from flowers and arrangements to customer sales and shop spending.",
    result: "Know which screen to check before planning the next purchase.",
  ...
  },
  {
    ...
    inside: "Match staff, upgrades, decoration, and passes to the bottleneck in front of you.",
    result: "Choose which progression system to inspect next.",
...
const loopFrames = [
  ...
  },
  {
    ...
    detail: "Use harvested flowers in bouquets and other arrangements when the current recipe fits your stock.",
  },
  {
